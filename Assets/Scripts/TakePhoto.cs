...
public class TakePhoto : MonoBehaviour
{
	...
	[SerializeField] public InventoryScript inv;
	...
	private void Start()
	{
		...
		//invCanvas = GameObject.Find("InventoryCanvas"); //using serialized reference in favor of GameObject.Find
		//fadeoutImage = GameObject.Find("Player/CameraCanvas/FadeOutImage"); //using serialized reference in favor of GameObject.Find
